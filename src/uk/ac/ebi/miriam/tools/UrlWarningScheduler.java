...
/**
 * <p>Launches the retrieval of the resources which have been detected down for several consecutive days, in order to inform the curator(s).
 * This is called weekly (on Tuesday morning) by a Quartz scheduler.
 *
 * <p>
 * <dl>
 * <dt><b>Copyright:</b></dt>
 ...
 * @version 20140424
 */
public class UrlWarningScheduler implements Job
{
    private static Logger logger = Logger.getLogger(UrlWarningScheduler.class);
    ...
    public void execute(JobExecutionContext arg0) throws JobExecutionException
    {
        ...
        if (hostName.equals("ves-ebi-6c.ebi.ac.uk") || hostName.equals("ves-hx-4d.ebi.ac.uk")){
            UrlWarning urlWarningProcess = new UrlWarning();
            if((urlWarningProcess.getVersion().equals("cura") && hostName.equals("ves-ebi-6c.ebi.ac.uk")) || (urlWarningProcess.getVersion().equals("devcura") && hostName.equals("ves-hx-4d.ebi.ac.uk"))) {
                logger.debug("Resources health warning in progress on '" + hostName + "'...");
                urlWarningProcess.check();
                logger.debug("Resources health warning finished.");
            }
        }
    }
}
