<%--
  ...
  Registry: displays the overview of the data collections belonging to a given subset (obsolete or restricted).
--%>
...
<h2 class="icon icon-generic" data-icon="D">Browse data collections: 
	<c:if test="${(preferences != null) && (!empty preferences)}">
	    <span style="color:rgb(94, 158, 158); font-style:italic;">&nbsp;${preferences}</span>
	</c:if></h2>
