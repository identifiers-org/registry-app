<%--
  ...
  MIRIAM Web Interface,
    'view' part of the application: diplays the the whole list of resources.
        ...
        <table class="contentspane" id="contentspane" summary="The main content pane of the page" style="width: 100%">
            <tr>
                ...
                <td class="contentsarea" id="contentsarea">
                    ...
                    <p>
					   Brief overview of the different resources stored in <em>MIRIAM Database</em>. 
					</p>
                    
                    <br />
                    
                    <display:table name="${data}" class="sqlresult" requestURI="/resources">   <%-- pagesize="20" --%>
                        <display:setProperty name="basic.msg.empty_list" value="Sorry there is no resource to display in this category." />
                        
                        <display:column property="idLink" title="Identifier" sortable="true" style="text-align:left; padding-left: 5px; padding-right: 5px;" />
                        <display:column property="name" title="Resource" sortable="true" defaultorder="ascending" style="text-align:left; padding-left: 5px; padding-right: 5px;" />
                        <display:column property="datatypeLink" title="Data type" sortable="true" style="text-align:left; padding-left: 5px; padding-right: 5px;" />
                        <display:column property="organisation" title="Organisation" sortable="true" style="text-align:left; padding-left: 5px; padding-right: 5px;" />
                        <display:column property="country" title="Country" sortable="true" style="padding-left: 5px; padding-right: 5px;" />
                        <%-- 
