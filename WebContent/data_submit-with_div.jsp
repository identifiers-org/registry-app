...
<jsp:include page="template_header.jsp" />
		...
		<c:choose>
			...
			<fieldset id="form_def_pattern">
				<legend>Definition and pattern&nbsp;<a href="javascript:;" title="Help" onclick="$('#HelpDef').toggle();"></a></legend>
				<div class="grid_4 alpha">
					Definition:&nbsp;
				</div>
				<div class="grid_20">
			...
			<fieldset id="form_uris">
				<legend>URIs&nbsp;<a href="javascript:;" title="Help" onclick="$('#HelpURIs').toggle();"></a></legend>
				<div class="grid_4 alpha">
					<c:choose>
						<%-- the user is logged in --%>
						<c:when test="${sessionScope.login != null}">
			...
			<fieldset id="form_resources">
				<legend>Resources&nbsp;<a href="javascript:;" title="Help" onclick="$('#HelpResources').toggle();"></a></legend>
			...
			<fieldset id="form_docs">
				<legend>Documentation&nbsp;<a href="javascript:;" title="Help" onclick="$('#HelpDocumentation').toggle();"></a></legend>
			...
			<%-- Spam trap: this field is not visible (cf. CSS) and its value should stay empty --%>
			...
			<c:if test="${(sessionScope.login == null) && (curator == null)}">
				...
				<fieldset id="form_user">
					<legend>User information&nbsp;<a href="javascript:;" title="Help" onclick="$('#HelpUser').toggle();"></a></legend>
					<div id="user_form">
            ...
            <c:if test="${(sessionScope.login != null) || (curator != null)}">
                <fieldset id="form_publi">
                    <legend>Publication&nbsp;<a href="javascript:;" title="Help" onclick="$('#HelpPubli').toggle();"></a></legend>
                    <table class="nothing">
                        <tr>
