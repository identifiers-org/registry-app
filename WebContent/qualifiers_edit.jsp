<%--
  ...
  MIRIAM Web Interface,
    'view' part of the application: displays the edition page of the BioModels.net qualifiers.  
        ...
        <table class="contentspane" id="contentspane" summary="The main content pane of the page" style="width: 100%">
            <tr>
                ...
                <td class="contentsarea" id="contentsarea">
                    ...
                    <h1>Edition of BioModels.net qualifiers</h1>
                    ...
                    <p>
                        With this form, you can create new <a href="<c:url value='/mdb?section=qualifiers' />" title="List of BioModels.net qualifiers">BioModels.net qualifiers</a>.
                    </p>
                    
                    <br />
                    
                    <form method="post" id="new_qualifier" action="addQualifier" class="basicForm">
                        <fieldset>
                            <legend>Add new qualifier&nbsp;<a href="javascript:;" title="Help" onclick="displayHelp('HelpAddNewQualifier')"><img src="${initParam.www}img/Help.gif" alt="Help logo" height="16" width="16" /></a></legend>
                            
                            <table summary="type of qualifiers select table">
                                <tr>
                                    <td>Type:&nbsp;</td>
                                    <td>
                                        <select name="type" id="type_id">
                                            <option value="">Select type of qualifier</option>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="name" size="46" id="newQualifierName_id" />
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <textarea cols="60" rows="3" name="def" id="newQualifierDef_id"></textarea>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <div class="help_add_existing" id="HelpAddNewQualifier" style="display: none;">
                            <div class="xround"><b class="xtop"><b class="xb1">&nbsp;</b><b class="xb2">&nbsp;</b><b class="xb3">&nbsp;</b><b class="xb4">&nbsp;</b></b><div class="xboxcontent">
                                <p>
                                    First select one of the existing types of qualifiers (it is currently not possible to create new type).
                                </p>
                                <p>
                                    After that, you just need to enter the qualifier name and definition and hit the 'Add' button.
                                </p>
